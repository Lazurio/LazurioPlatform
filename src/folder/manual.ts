...
const workingHere = document("Working here", generated, [
  ...
  "Create worktrees, commit and push to the PR branch continuously, and open pull requests as GitHub Draft PRs. Work never stays only local: from the first push it is visible as a Draft PR, and once it is finished and verified you switch it to Ready for review yourself. Ready is not Publication; it says “ready to be checked”. A remote branch without a PR is not a handoff.",
  "",
