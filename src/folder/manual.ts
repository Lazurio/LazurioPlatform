...
const workingHere = document("Working here", generated, [
  ...
  "Create worktrees, commit and push to the PR branch continuously, and open pull requests. Work never stays only local: while it is in progress it is visible from the first push as a GitHub Draft PR, and once it is finished and verified you switch the PR to Ready for review yourself. Ready is not Publication; it only says “ready to be checked”. Finished work never stays a Draft, and a remote branch without a PR is not a handoff.",
  "",
